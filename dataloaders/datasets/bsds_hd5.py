...
class Mydataset(data.Dataset):
    def __init__(self,root_path='....../Augmentation/', split='trainval',crop_size=513):
        ...
        if self.split == 'trainval':
            print('trainval_pair_ms_py.lst')
            list_file = os.path.join(root_path,'trainval_pair_ms_py.lst')
        else:
...
if __name__ == '__main__':
    train_dataset = Mydataset(root_path='/home/pumengyang/Data/BSDS-RIND/DOOBNet_data7/Augmentation/', split='trainval', crop_size=320)
