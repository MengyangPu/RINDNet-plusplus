...
class BDCN_Options:
    def __init__(self):
        ...
        self.parser.add_argument('--start-iters', type=int, default=0, metavar='N',
                                 help='number of start iter to train (default: 0)')
        self.parser.add_argument('--total-iters', type=int, default=80000, metavar='N',
                                 help='number of iters to train (default: auto)')
        self.parser.add_argument('--snapshots', type=int, default=20000, metavar='N',
        ...
        # optimizer params
        self.parser.add_argument('--lr', type=float, default=1e-8, metavar='LR',
                                 help='learning rate (default: auto)')
        self.parser.add_argument('--minlr', type=float, default=1e-10, metavar='LR',
                                 help='min-learning rate (default: auto)')
        ...
        self.parser.add_argument('--checkname', type=str, default='bdcn',
